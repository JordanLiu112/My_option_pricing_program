...
#include <cmath>
#include <iostream>
#include "StandardError.h" //for calculating standard deviation and standard error
...
{  // A generic print function for vectors
	...
	//std::vector<T>::const_iterator i; //this leads to an error
...
int main()
{
	...
	std::vector<double> payoffs(NSim); //vector of payoffs from each simulation
	...
	{ // Calculate a path at each iteration
		...
		payoffs[i - 1] = tmp; //assign payoff to payoffs vector
	...
	// E. Calculate standard deviation and standard error
	double SD1 = SD(payoffs, myOption.r, myOption.T);
	double SE1 = SE(SD1, NSim);
	...
	std::cout << "Standard Deviation: " << SD1 << endl;
	std::cout << "Standard Error: " << SE1 << endl;
